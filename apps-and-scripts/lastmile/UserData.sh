...
curl https://raw.githubusercontent.com/ddcdennisb/amazon-ec2-mac-getting-started/main/apps-and-scripts/lastmile/Main.scpt -o /Users/Shared/.LastMile/Main.scpt
